...
public class MovieWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "com.example.wakhyudi.noviedb.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.example.wakhyudi.noviedb.EXTRA_ITEM";
